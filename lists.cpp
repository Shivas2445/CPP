// C++ std::list Reference Notes
// -----------------------------------
// This file demonstrates the most common operations on std::list in C++.
// Each section is commented for clarity. Use this as a reference for learning lists.
